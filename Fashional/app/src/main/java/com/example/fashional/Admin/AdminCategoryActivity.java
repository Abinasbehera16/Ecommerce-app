...
import com.example.fashional.HomeActivity;
import com.example.fashional.MainActivity;
...
public class AdminCategoryActivity extends AppCompatActivity
{
    ...
    private Button LogoutBtn, CheckOrfderBtn, maintainProductsBtn;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        CheckOrfderBtn=(Button)findViewById(R.id.check_orders_btn);
        ...
        CheckOrfderBtn.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
