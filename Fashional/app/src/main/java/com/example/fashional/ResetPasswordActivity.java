                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                {
                    if (dataSnapshot.exists())
                    {
                        ...
                        if( dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this,"Your 1 answer is wrong..",Toast.LENGTH_SHORT).show();
                            }
                            else if(!ans2.equals(answer2))
                            {
                                Toast.makeText(ResetPasswordActivity.this,"Your 2 answer is wrong..",Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
