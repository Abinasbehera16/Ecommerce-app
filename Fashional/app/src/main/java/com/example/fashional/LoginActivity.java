...
import com.example.fashional.Admin.AdminCategoryActivity;
import com.example.fashional.Model.Users;
    ...
    private void AllowAcessToAccount(final String phone, final String password)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    if(usersData.getPhone().equals(phone))
                    {
                        if(usersData.getPassword().equals(password))
                        {
                            if(parentDbName.equals("Admins"))
                            {
                                ...
                                loadingBar.dismiss();
                                Intent intent=new Intent(LoginActivity.this, AdminCategoryActivity.class); // name ,value:-" ",
                                startActivity(intent);
                            }
                ...
                {
                    Toast.makeText(LoginActivity.this,"Account with this" +phone+ "phone number do not exists.",Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
