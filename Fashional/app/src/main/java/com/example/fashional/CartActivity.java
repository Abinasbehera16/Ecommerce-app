        ...
        orderRef.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
              if(dataSnapshot.exists())
              {
                  ...
                  {
                      txtTotalAmount.setText("Dear" + userName +"/n order is shipped successfully of an amount of ₹"+ overTotalPrice);
                      ...
                      Toast.makeText(CartActivity.this,"You can purchase more product, once you received your final order",Toast.LENGTH_SHORT).show();
